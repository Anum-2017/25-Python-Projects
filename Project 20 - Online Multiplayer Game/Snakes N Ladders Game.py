...
board= pygame.image.load("image/Snakes-and-Ladders-Bigger.jpg")
dice1=pygame.image.load("image/dice/Dice1.png")
dice2=pygame.image.load("image/dice/Dice2.png")
dice3=pygame.image.load("image/dice/Dice3.png")
dice4=pygame.image.load("image/dice/Dice4.png")
dice5=pygame.image.load("image/dice/Dice5.png")
dice6=pygame.image.load("image/dice/Dice6.png")

redgoti=pygame.image.load("image/players goti/redgoti.png")
yellowgoti=pygame.image.load("image/players goti/yellowgoti.png")
greengoti=pygame.image.load("image/players goti/greengoti.png")
bluegoti=pygame.image.load("image/players goti/bluegoti.png")
menubg=pygame.image.load("image/intropic/menu.jpg")
p=pygame.image.load("image/playbg.jpg")
intbg=pygame.image.load("image/intropic/intropic.png")
intbg2=pygame.image.load("image/intropic/intropic2.jpg")
intbg3=pygame.image.load("image/intropic/intropic3.jpg")
intbg4=pygame.image.load("image/intropic/intropic4.jpg")
intbg5=pygame.image.load("image/intropic/intropic5.jpg")

pygame.mixer.music.load("image/sounds/music.wav")
snakesound=pygame.mixer.Sound("image/sounds/snake.wav")
win=pygame.mixer.Sound("image/sounds/win.wav")
lose=pygame.mixer.Sound("image/sounds/lose.wav")
ladder=pygame.mixer.Sound("image/sounds/ladder.wav")
